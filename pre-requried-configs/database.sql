...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2023-08-26 20:37:04',NULL),('diagnostics.include_raw','OFF','2023-08-26 20:37:04',NULL),('ps_thread_trx_info.max_length','65535','2023-08-26 20:37:04',NULL),('statement_performance_analyzer.limit','100','2023-08-26 20:37:04',NULL),('statement_performance_analyzer.view',NULL,'2023-08-26 20:37:04',NULL),('statement_truncate_len','64','2023-08-26 20:37:04',NULL);
...
-- Dump completed on 2023-10-20 17:31:46
-- MySQL dump 10.13  Distrib 8.0.34, for Win64 (x86_64)
--
...
CREATE TABLE `billing` (
  ...
  `date_time_parked_out` datetime DEFAULT NULL,
  `total_charges` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `vehicle_id` (`vehicle_id`),
  CONSTRAINT `billing_ibfk_1` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`)
...
INSERT INTO `billing` VALUES (-1,-1,'1999-01-01','00:00:00','1999-01-01 00:00:00',0),(1,1,'2023-09-29','11:46:00','2023-10-12 15:20:00',40),(2,14,'2023-10-16','10:17:00',NULL,NULL),(3,14,'2023-10-16','10:17:00','2023-10-16 10:17:00',10);
...
CREATE TABLE `credentials` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `credentials_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `employee` (`id`)
...
INSERT INTO `credentials` VALUES (1,'abhi','91301e05e44406c12a4626a2382df30b04543c0561e10f5471f24c0928645109',1),(2,'kittu','f955929b29e6b08c795f25361829c954b1b864fddfc9a28b812b2102f9c8c26e',2);
...
INSERT INTO `customer` VALUES (-1,'Test','Test','1000000001'),(1,'Ram','ram@gmail.com','1234567899'),(2,'Raju','raju@gmail.com','7654212345');
...
INSERT INTO `employee` VALUES (1,'Abhijeet Singh','abhi22hada@gmail.com','9602606500'),(2,'Kittu','kittu@gmail.com','8619892052');
...
CREATE TABLE `role_mapping` (
  ...
  KEY `user_id` (`user_id`),
  KEY `role_id` (`role_id`),
  CONSTRAINT `role_mapping_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `employee` (`id`),
  CONSTRAINT `role_mapping_ibfk_2` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `role_mapping` VALUES (1,1,1),(2,1,2),(3,2,2);
...
CREATE TABLE `slot` (
  ...
  PRIMARY KEY (`id`),
  KEY `slot_category_id` (`slot_category_id`),
  KEY `status_id` (`status_id`),
  KEY `billing_id` (`billing_id`),
  KEY `slot_ibfk_1` (`vehicle_id`),
  CONSTRAINT `slot_ibfk_1` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`),
  CONSTRAINT `slot_ibfk_2` FOREIGN KEY (`slot_category_id`) REFERENCES `slot_category` (`id`),
  CONSTRAINT `slot_ibfk_3` FOREIGN KEY (`status_id`) REFERENCES `slot_status` (`id`),
  CONSTRAINT `slot_ibfk_4` FOREIGN KEY (`billing_id`) REFERENCES `billing` (`id`)
...
CREATE TABLE `slot_category` (
  ...
  `charge` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `slot_type_UNIQUE` (`slot_type`)
...
LOCK TABLES `slot_category` WRITE;
/*!40000 ALTER TABLE `slot_category` DISABLE KEYS */;
INSERT INTO `slot_category` VALUES (1,'LMV',2,10),(2,'HMV',10,50);
/*!40000 ALTER TABLE `slot_category` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `slot_status` WRITE;
/*!40000 ALTER TABLE `slot_status` DISABLE KEYS */;
INSERT INTO `slot_status` VALUES (1,'Not Allowed'),(2,'Allowed');
/*!40000 ALTER TABLE `slot_status` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `vehicle` (
  ...
  `slot_category_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `customer_id` (`customer_id`),
  KEY `vehicle_ibfk_2` (`slot_category_id`),
  CONSTRAINT `vehicle_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`id`),
  CONSTRAINT `vehicle_ibfk_2` FOREIGN KEY (`slot_category_id`) REFERENCES `slot_category` (`id`)
...
INSERT INTO `vehicle` VALUES (-1,-1,'0',NULL),(1,1,'RJ20CD7259',1),(14,2,'RJ91BW7711',1);
/*!40000 ALTER TABLE `vehicle` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'parkingmanagement'
--

--
-- Dumping routines for database 'parkingmanagement'
--
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- MySQL dump 10.13  Distrib 8.0.34, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: todoapplicationdatabase
-- ------------------------------------------------------
-- Server version	8.0.34
...
--
-- Dumping events for database 'todoapplicationdatabase'
--

--
-- Dumping routines for database 'todoapplicationdatabase'
--
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
